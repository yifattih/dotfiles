...
local function FloatingTerminal()
    ...
    if not terminal_state.buf or not vim.api.nvim_buf_is_valid(terminal_state.buf) then
        terminal_state.buf = vim.api.nvim_create_buf(
            false,
            true
        )
...
-- Other modules can send commands to it
local function SendToTerminal(cmd)
    if not terminal_state.buf or not vim.api.nvim_buf_is_valid(terminal_state.buf) then
        FloatingTerminal()
    end
