...
Snap packages installer script.
...
By default FILE_PATH=${HOME}/dotfiles/snap_packages.txt
EOF
  exit
}
...
parse_params() {
  local FILE_FLAG=0
  FILE_PATH="${script_dir}/../snap-packages.txt"
  VERBOSE=0
...
log "Installing packages using the Snap"
